package com.leonardorezende.workshopmongo.config;
...
import com.leonardorezende.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c2 = new CommentDTO("Aproveite", sdf.parse("20/03/2022"), new AuthorDTO(bob));
		CommentDTO c3 = new CommentDTO("Tenha uma ótima semana", sdf.parse("22/03/2022"), new AuthorDTO(alex));
